...
require 'config.php';
$id = $_GET['id'];
$query = mysqli_query($koneksi, "SELECT * FROM daily WHERE
							id_daily='$id'");
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <form action="api_editstatusharian.php" method="POST">

                                <input type="hidden" class="form-control" id="id" name="id_daily" value="<?php echo "$edit[id_daily]" ?>">
