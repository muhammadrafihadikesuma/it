...
<aside id="sidebar" class="sidebar">
  ...
  <ul class="sidebar-nav" id="sidebar-nav">
    ...
    <li class="nav-item">
      ...
      <ul id="rencana-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
        <li>
          <a href="data_kegiatan.php">
            <i class="bi bi-circle"></i><span>Data Rencana Kegiatan</span>
          </a>
        </li>
        <li>
          <a href="input_kegiatan.php">
            <i class="bi bi-circle"></i><span>Input Rencana Kegiatan</span>
          </a>
        </li>
      </ul>
    </li>
    ...
    <li class="nav-item">
      <a class="nav-link collapsed" href="input_kegiatan.php">
        <i class="bi bi-pencil-square"></i>
