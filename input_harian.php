...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            <h1>INPUT KEGIATAN HARIAN</h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="home.php">Home</a></li>
                    <li class="breadcrumb-item"><a href="data_harian.php">Data Kegiatan Harian</a></li>
                    <li class="breadcrumb-item active">Input Kegiatan Harian</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        <section class="section">
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        <div class="card-body">
                            <h5 class="card-title">Input Kegiatan Harian</h5>

                            <!-- General Form Elements -->
                            <form action="api_inputharian.php" method="POST">

                                <input type="hidden" class="form-control" id="id" name="id_daily">
                                ...
                                <div class="col-12">
                                 ...
                                 <div class="col-12">
                                    <div id="datetimepicker2" class="form-floating mb-3">
                                        <input type="time" name="time" class="form-control" id="datetimepicker" required>
