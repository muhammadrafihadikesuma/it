                        ...
                        <div class="col-lg-4 col-md-6 d-flex flex-column align-items-center justify-content-center">
                            ...
                            <div class="card mb-3">
                                ...
                                <div class="card-body">
                                    ...
                                    <form action="actionlogin.php" Method="POST" class="row g-3 needs-validation" novalidate>
                            ...
                            <div class="credits">
                                <div class="copyright">
                                    <strong><span> &copy; 2022 PT. PINANG WITMAS SEJATI </span></strong>
                                </div>
                            </div>
